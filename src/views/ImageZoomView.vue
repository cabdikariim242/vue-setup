<template>
    ...
    <img
      :class="zoomed ? 'scale-150' : 'scale-90'"
...
<div>
    ...
    <img
      :src="imageSrc"
      @click="openZoom"
      class="cursor-zoom-in w-64 h-64 object-cover-center rounded ml-6 mt-4 mb-4"
      alt="Zoomable image"
    />
    ...
    >
      <img
        :src="imageSrc"
        class="max-w-full max-h-full transition-transform duration-300 transform scale-100"
        alt="Zoomed image"
      />
      <button
